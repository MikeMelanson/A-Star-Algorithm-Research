 ...
 * Throw away large elements
 */

public class ArrayTreeSmallAtTop_Discard extends DataStructure {
	...
	public ArrayTreeSmallAtTop_Discard(int n){
		maxsize = n+1;
